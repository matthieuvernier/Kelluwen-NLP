  ...
  */  
  ...
  public double getLatitude() {
    if (Country_Type.featOkTst && ((Country_Type)jcasType).casFeat_latitude == null)
      jcasType.jcas.throwFeatMissing("latitude", "cl.uach.kelluwen.nlp.location.Country");
  ...
  public double getLongitude() {
    if (Country_Type.featOkTst && ((Country_Type)jcasType).casFeat_longitude == null)
      jcasType.jcas.throwFeatMissing("longitude", "cl.uach.kelluwen.nlp.location.Country");
  ...
  public String getNormalizedName() {
    if (Country_Type.featOkTst && ((Country_Type)jcasType).casFeat_normalizedName == null)
      jcasType.jcas.throwFeatMissing("normalizedName", "cl.uach.kelluwen.nlp.location.Country");
